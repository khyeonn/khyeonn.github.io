...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/odrone/validate-2/case_02_air_data.png" class="img-fluid rounded z-depth-99" zoomable=true %}
        <div class="caption">
            Comparison of atmospheric data for Case 2.
        </div>
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/odrone/validate-2/case_02_angular_rate.png" class="img-fluid rounded z-depth-99" zoomable=true %}
        <div class="caption">
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/odrone/validate-2/case_02_euler_angle.png" class="img-fluid rounded z-depth-99" zoomable=true %}
        <div class="caption">
            Comparison of Euler angles for Case 2.
        </div>
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/odrone/validate-2/case_02_ned_velocity.png" class="img-fluid rounded z-depth-99" zoomable=true %}
        <div class="caption">
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/odrone/validate-3/case_03_air_data.png" class="img-fluid rounded z-depth-99" zoomable=true %}
        <div class="caption">
            Comparison of atmospheric data for Case 3.
        </div>
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/odrone/validate-3/case_03_angular_rate.png" class="img-fluid rounded z-depth-99" zoomable=true %}
        <div class="caption">
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/odrone/validate-3/case_03_euler_angle.png" class="img-fluid rounded z-depth-99" zoomable=true %}
        <div class="caption">
            Comparison of Euler angles for Case 3.
        </div>
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/odrone/validate-3/case_03_ned_velocity.png" class="img-fluid rounded z-depth-99" zoomable=true %}
        <div class="caption">
